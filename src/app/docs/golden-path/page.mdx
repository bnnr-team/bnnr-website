...
> **Start here first:** [`bnnr.quick_run()`](/docs/api-reference/) for classification, or `python -m bnnr demo` for a zero-flag CLI showcase. This page is for custom adapters, multi-label, and detection. Third-party stacks: [Integrations](https://github.com/bnnr-team/bnnr/blob/main/docs/integrations.md).
