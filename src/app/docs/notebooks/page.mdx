...
| `examples/detection/bnnr_detection_demo.ipynb` | YOLOv8 on COCO128: bbox-aware augmentations, mAP, and three-panel detection XAI (`bnnr` ≥ 0.2.9 on PyPI / Colab) | Required (live tracking) | Medium–Long |
