...
| `examples/detection/bnnr_detection_demo.ipynb` | YOLOv8 on COCO128: bbox-aware augmentations, mAP, and three-panel detection XAI (`bnnr` ≥ 0.3.0 on PyPI / Colab) | Required (live tracking) | Medium–Long |
