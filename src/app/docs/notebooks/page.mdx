...
2. Runtime → Change runtime type → GPU (recommended for larger models and longer runs).
...
For classification and multilabel notebooks:
...
- Expecting full training runs to finish quickly on CPU without reducing epochs or sample counts.
