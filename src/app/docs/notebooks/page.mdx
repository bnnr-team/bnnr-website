...
| `examples/bnnr_custom_data.ipynb` | Bring-your-own classification/multilabel data patterns | Recommended | Medium |
...
2. Runtime -> Change runtime type -> GPU (recommended for faster runs).
...
- Expecting full multilabel runs to finish quickly on CPU.
- Confusing dataset format with BNNR config YAML.
