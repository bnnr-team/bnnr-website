...
const LINES = [
  ...
  { type: "output", text: "Successfully installed bnnr-0.4.14" },
  { type: "blank", text: "" },
  { type: "prompt", text: "$ " },
  { type: "command", text: "python -m bnnr demo" },
  { type: "blank", text: "" },
  { type: "banner", text: "BNNR v0.4.14 — Train → Explain → Improve → Prove" },
  { type: "blank", text: "" },
  { type: "output", text: "▸ Demo:       CIFAR-10 (32×32, 10 classes, ~1 min)" },
  { type: "output", text: "▸ Preset:     ICD" },
  ...
  { type: "output", text: "Interactive wizard — choose dataset, preset, and limits" },
];
